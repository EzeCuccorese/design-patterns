...
import { BookOpen, AlertTriangle, Code, CheckCircle, ChevronDown, ChevronRight, Wrench } from 'lucide-react';
...
export const RefactorDetail: React.FC = () => {
  ...
  return (
    <div className="bento-grid" style={{ gap: '20px' }}>
      ...
      {/* CARD 1: ¿QUÉ ES REFACTORIZAR? & DEUDA TÉCNICA */}
        ...
        <div className="card-body">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            ...
            <div style={{ border: '1px solid var(--border-color)', borderRadius: '8px', overflow: 'hidden' }}>
              <button
                onClick={() => setExpandedSmell(expandedSmell === 'bloaters' ? null : 'bloaters')}
                style={{
            ...
            <div style={{ border: '1px solid var(--border-color)', borderRadius: '8px', overflow: 'hidden' }}>
              <button
                onClick={() => setExpandedSmell(expandedSmell === 'abusers' ? null : 'abusers')}
                style={{
                  width: '100%', padding: '10px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  background: 'var(--bg-app)', border: 'none', cursor: 'pointer', color: 'var(--text-primary)', fontWeight: 'bold', fontSize: '13px'
                }}
            ...
            <div style={{ border: '1px solid var(--border-color)', borderRadius: '8px', overflow: 'hidden' }}>
              <button
                onClick={() => setExpandedSmell(expandedSmell === 'change' ? null : 'change')}
                style={{
                  width: '100%', padding: '10px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  background: 'var(--bg-app)', border: 'none', cursor: 'pointer', color: 'var(--text-primary)', fontWeight: 'bold', fontSize: '13px'
                }}
            ...
            <div style={{ border: '1px solid var(--border-color)', borderRadius: '8px', overflow: 'hidden' }}>
              <button
                onClick={() => setExpandedSmell(expandedSmell === 'dispensables' ? null : 'dispensables')}
                style={{
                  width: '100%', padding: '10px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  background: 'var(--bg-app)', border: 'none', cursor: 'pointer', color: 'var(--text-primary)', fontWeight: 'bold', fontSize: '13px'
                }}
            ...
            <div style={{ border: '1px solid var(--border-color)', borderRadius: '8px', overflow: 'hidden' }}>
              <button
                onClick={() => setExpandedSmell(expandedSmell === 'couplers' ? null : 'couplers')}
                style={{
                  width: '100%', padding: '10px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  background: 'var(--bg-app)', border: 'none', cursor: 'pointer', color: 'var(--text-primary)', fontWeight: 'bold', fontSize: '13px'
                }}
      ...
      <div className="bento-card" style={{ gridColumn: 'span 6', gridRow: 'span 3' }}>
        ...
        <div className="card-body">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            ...
            <div style={{ border: '1px solid var(--border-color)', borderRadius: '8px', overflow: 'hidden' }}>
              <button
                onClick={() => setExpandedTech(expandedTech === 'composing' ? null : 'composing')}
                style={{
                  width: '100%', padding: '10px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  background: 'var(--bg-app)', border: 'none', cursor: 'pointer', color: 'var(--text-primary)', fontWeight: 'bold', fontSize: '13px'
                }}
            ...
            <div style={{ border: '1px solid var(--border-color)', borderRadius: '8px', overflow: 'hidden' }}>
              <button
                onClick={() => setExpandedTech(expandedTech === 'moving' ? null : 'moving')}
                style={{
                  width: '100%', padding: '10px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  background: 'var(--bg-app)', border: 'none', cursor: 'pointer', color: 'var(--text-primary)', fontWeight: 'bold', fontSize: '13px'
                }}
            ...
            <div style={{ border: '1px solid var(--border-color)', borderRadius: '8px', overflow: 'hidden' }}>
              <button
                onClick={() => setExpandedTech(expandedTech === 'data' ? null : 'data')}
                style={{
                  width: '100%', padding: '10px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  background: 'var(--bg-app)', border: 'none', cursor: 'pointer', color: 'var(--text-primary)', fontWeight: 'bold', fontSize: '13px'
                }}
            ...
            <div style={{ border: '1px solid var(--border-color)', borderRadius: '8px', overflow: 'hidden' }}>
              <button
                onClick={() => setExpandedTech(expandedTech === 'conditionals' ? null : 'conditionals')}
                style={{
                  width: '100%', padding: '10px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  background: 'var(--bg-app)', border: 'none', cursor: 'pointer', color: 'var(--text-primary)', fontWeight: 'bold', fontSize: '13px'
                }}
              ...
              {expandedTech === 'conditionals' && (
                <div style={{ padding: '12px', borderTop: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '12.5px', backgroundColor: 'var(--bg-card)' }}>
                  ...
                  <div><strong>• Reemplazar Anidados con Cláusulas de Guarda:</strong> Retornar temprano (`return` / cláusulas de guarda) para aplanar la indentación y evitar anidamientos infinitos de `if-else`.</div>
            ...
            <div style={{ border: '1px solid var(--border-color)', borderRadius: '8px', overflow: 'hidden' }}>
              <button
                onClick={() => setExpandedTech(expandedTech === 'calls' ? null : 'calls')}
                style={{
                  width: '100%', padding: '10px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  background: 'var(--bg-app)', border: 'none', cursor: 'pointer', color: 'var(--text-primary)', fontWeight: 'bold', fontSize: '13px'
                }}
            ...
            <div style={{ border: '1px solid var(--border-color)', borderRadius: '8px', overflow: 'hidden' }}>
              <button
                onClick={() => setExpandedTech(expandedTech === 'generalization' ? null : 'generalization')}
                style={{
                  width: '100%', padding: '10px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  background: 'var(--bg-app)', border: 'none', cursor: 'pointer', color: 'var(--text-primary)', fontWeight: 'bold', fontSize: '13px'
                }}
              ...
              {expandedTech === 'generalization' && (
                <div style={{ padding: '12px', borderTop: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '12.5px', backgroundColor: 'var(--bg-card)' }}>
                  ...
                  <div><strong>• Reemplazar Herencia con Delegación:</strong> Cambiar un enlace rígido de subclase por composición si la clase hija no aprueba la prueba de herencia "es un" (is-a).</div>
                </div>
              )}
            </div>
      ...
      {/* CARD 4: DETALLE DEL EJEMPLO Y VISUALIZADOR DE CÓDIGO (JAVA, PYTHON, NODE, GO) */}
